...
const contactItems = [
  ...
  },
  {
    ...
    title: "Email",
    value: " mustafaalimuhammad806@gmail.com",
    color: "secondary",
    delay: 0.2,
    link: "mailto: mustafaalimuhammad806@gmail.com",
  },
  {
    icon: "fas fa-phone-alt",
    title: "Phone",
    value: "+92-314-0328646",
    color: "accent",
    delay: 0.3,
...
const socialLinks = [
  {
    icon: "fab fa-github",
    url: "https://github.com/Mustafa-ali123",
    color: "primary",
    hoverColor: "primary",
    delay: 0.1,
  },
  {
    ...
    url: "https://www.linkedin.com/in/mustafa-ali-7b644a287/",
    color: "secondary",
