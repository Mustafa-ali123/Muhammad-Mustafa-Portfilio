  ...
  app.post(`${apiPrefix}/contact`, async (req: Request, res: Response) => {
    try {
      ...
      return res.status(200).json({
        message: "Message received! Thank you for contacting Muhammad Mustafa.",
      });
    } catch (error) {
...
Contact: “You can reach me at +92-316-0010801 or  mustafaalimuhammad806@gmail.com. Check out my GitHub at github.com/muhammadhamidraza for some of my work!”
